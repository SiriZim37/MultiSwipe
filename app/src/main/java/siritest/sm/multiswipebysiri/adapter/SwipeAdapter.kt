...
import siritest.sm.multiswipebysiri.util.SwipeTouchHelper
import siritest.sm.multiswipebysiri.util.drawHorizontalDividers
import siritest.sm.multiswipebysiri.util.drawVerticalDividers
import kotlin.math.abs
import siritest.sm.multiswipebysiri.adapter.SwipeRecyclerView.ListOrientation.DirectionFlag
import siritest.sm.multiswipebysiri.adapter.SwipeRecyclerView.ListOrientation
...
abstract class SwipeAdapter<T, U : SwipeAdapter.ViewHolder>(
    ...
    private fun drawOnSwiping(
        ...
        recyclerView?.let { list ->
            ...
            val isSwipingHorizontally = (orientation.swipeFlagsValue and SwipeRecyclerView.ListOrientation.DirectionFlag.RIGHT.value == DirectionFlag.RIGHT.value)
