...
import siritest.sm.multiswipebysiri.util.SwipeItemDecoration

open class SwipeRecyclerView @JvmOverloads constructor(
    context: Context,
    ...
    /**
     * Indicates the orientation of a recycler view of type SwipeRecyclerView.
     */
    ...
    private var itemDecoration: SwipeItemDecoration? = null
        ...
        private set(value) {
            if (value != field) {
                ...
                if (itemDecoration == null) {
                    if (value != null) {
                        val newItemDecoration = SwipeItemDecoration(value)
