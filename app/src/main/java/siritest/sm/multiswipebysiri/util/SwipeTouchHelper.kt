package siritest.sm.multiswipebysiri.util

import android.graphics.Canvas
import androidx.recyclerview.widget.ItemTouchHelper
import androidx.recyclerview.widget.RecyclerView
import siritest.sm.multiswipebysiri.adapter.SwipeAdapter
import siritest.sm.multiswipebysiri.listener.OnItemSwipeListener.SwipeDirection
...
internal class SwipeTouchHelper(
        ...
        internal var recyclerView: SwipeRecyclerView?
    ...
    override fun canDropOver(
            ...
            (target as? SwipeAdapter.ViewHolder)?.canBeDroppedOver?.invoke() == true
